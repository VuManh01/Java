...
public class ConsoleUI {
    ...
    public static void menuManager() throws SQLException {
        System.out.println("1.List of students lending books");
        System.out.println("2.Create students to lending books");
        System.out.println("3.Search list");
        System.out.println("4.Students return books");
        System.out.println("5.Update students to lending book");
        Scanner scanner = new Scanner(System.in);
        int choice = scanner.nextInt();
        switch (choice){
            case 1:
        ...
        while (!exit){
            ...
            switch (choice){
                ...
                case 2:
                    ...
                    break;
                case 3:
                    System.out.println("Manage student lending books");
                    menuManager();
                case 0:
                    scanner.close();
                    System.exit(0);
